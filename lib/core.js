...
var EchartsReactCore = function (_Component) {
  ...
  _createClass(EchartsReactCore, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!(0, _fastDeepEqual2["default"])(prevProps.theme, this.props.theme) || !(0, _fastDeepEqual2["default"])(prevProps.opts, this.props.opts) || !(0, _fastDeepEqual2["default"])(prevProps.onEvents, this.props.onEvents) || !(0, _fastDeepEqual2["default"])(prevProps.option, this.props.option)) {
        this.dispose();
